...
def write_Betsy_parameters_file(parameters, data_nodes,
                                pipeline,starttime,user,job_name):
    st = os.stat(parameters['filename'])
    ...
    if isinstance(data_nodes, tuple):
        ...
        text = ['Module input:', [(data_node.datatype.name,
        ...
        if 'filename' in data_nodes.attributes:
            identifier = data_nodes.attributes['filename']
        else:
            identifier = data_nodes.attributes['GSEID'] + data_nodes.attributes['GPLID']
        text = ['Module input:', (data_nodes.datatype.name,
                                  identifier),
                'Module output parameters:', parameters,
                'Pipeline module sequence:', pipeline,
                'Start time:',starttime,
