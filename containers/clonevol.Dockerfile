...
# ClonEvol and dependencies.

RUN Rscript -e "install.packages('devtools')"
RUN Rscript -e "devtools::install_github('hdng/clonevol')"
RUN Rscript -e "install.packages('gridBase')"
RUN Rscript -e "install.packages('gridExtra')"
RUN Rscript -e "install.packages('ggplot2')"
RUN Rscript -e "install.packages('igraph')"
RUN Rscript -e "install.packages('packcircles')"
RUN Rscript -e "devtools::install_github('hdng/trees')"


# Fishplot.

RUN Rscript -e "devtools::install_github('chrisamiller/fishplot')"
