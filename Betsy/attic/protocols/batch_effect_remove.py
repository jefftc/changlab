...
CATEGORIES = [COMMON, OPTIONAL, NORMALIZE, ILLUMINA, CLASS_NEIGHBORS]
...
PARAMETERS = [
    ...
    Parameter('shiftscale_norm',
              ...
              datatype='SignalFile'), Parameter('dwd_norm',
                                                pretty_name='Dwd',
                                                choices=['yes', 'no'],
                                                category=NORMALIZE,
    ...
    Parameter('num_features',
              ...
              datatype='SignalFile'), Parameter('platform',
    ...
    Parameter(
        ...
        category=OPTIONAL), Parameter(
            ...
            datatype='UserInput'), Parameter(
                ...
                datatype='UserInput'),  ###illumina related
    Parameter(
        'ill_manifest',
    ...
    Parameter(
        ...
        datatype="ILLUFolder"),  #class neighbors
    Parameter(
        'cn_mean_or_median',
        ...
        datatype='GeneListFile'), Parameter(
            'cn_filter_data',
            choices=['yes', 'no'],
            category=CLASS_NEIGHBORS,
    ...
    Parameter('cn_min_folddiff',
              ...
              datatype='UserInput'), Parameter(
                  ...
                  datatype='UserInput'),  #PcaAnalysis
    Parameter('pca_gene_num',
              pretty_name='PCA Gene Number',
              category=OPTIONAL,
              description='gene number in PCA',
