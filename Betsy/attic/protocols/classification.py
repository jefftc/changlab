...
PARAMETERS = [
    ...
    Parameter('classification',
              pretty_name='Classification Method',
              choices=['svm', 'weightedvoting', 'randomforest'],
              category=CLASSIFY,
              description='classification method',
              datatype='ClassifyFile'),
    Parameter(
        'svm_kernel',
        pretty_name='SVM Kernel',
        choices=['linear', 'polynomial', 'rbf', 'sigmoid', 'precomputed_kernel'],
        category=CLASSIFY,
        description='svm kernel',
        datatype='ClassifyFile'),
    Parameter('wv_feature_stat',
              pretty_name='Weighted Voting Feature Stat',
              ...
              category=CLASSIFY,
              description='weighted voting feature stat method',
              datatype='ClassifyFile'),
    Parameter('wv_minstd',
              pretty_name='Weight Voted min std',
              type='float',
              category=CLASSIFY,
