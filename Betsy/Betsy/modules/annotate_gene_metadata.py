...
def run(parameters, objects, pipeline):
    ...
    if chipname:
        ...
        if not chipfilename:
            raise AssertionError('I cannot annotate array platform :%s"'
                                 % chipname)
        assert os.path.exists(chipfilename), (
            'the annotation file %s does not exist' % chipfilename)
        if chipname in ['MG_U74Av2', 'HG_U133_Plus_2', 'Mu11KsubA',
                        'Mu11KsubB', 'Hu6800', 'HG_U133B', 'Mouse430_2',
                        'RG_U34A', 'Mouse430A_2', 'HG_U95A', 'HG_U133A',
                        'RAE230A', 'Hu35KsubC', 'Hu35KsubB', 'Hu35KsubA',
                        'Hu35KsubD', 'MG_U74Cv2', 'HG_U133A_2',
                        'MG_U74Bv2', 'HG_U95Av2']:
        ...
        elif chipname in ['Entrez_ID_human', 'Entrez_ID_mouse',
...
def get_identifier(parameters, objects):
    ...
    assert os.path.exists(single_object.identifier), (
        'the input file %s for annot_file does not exist'
