...
column_name=[COMMON,NORMALIZE,OPTIONAL,ILLUMINA,CLASS_NEIGHBORS,SCORE_PATHWAY]
#input predicates
INPUTS = [
    'gse_id',
    'class_label_file',
...
gene_normalize = Parameter('gene_normalize','Gene Normalize',
                           ...
                           NORMALIZE,'')
quantile = Parameter('quantile','Quantile','yes_quantile', None,
...
pca_gene_num = Parameter('pca_gene_num','PCA Gene Number',None,'integer',None,
                           OPTIONAL,'')
unique_genes = Parameter('unique_genes','Unique Genes','high_var',None,
...
duplicate_probe = Parameter('duplicate_probe','Duplicate Probe','yes_duplicate_probe',None,
                            ['yes_duplicate_probe', 'high_var_probe','closest_probe'],OPTIONAL,'')
has_annotation_gene_id = Parameter('has_annotation_gene_id','Annotation Gene Id','yes_gene_id',None,
                                   ['yes_gene_id','no_gene_id'],OPTIONAL,'')
group_fc = Parameter('group_fc', 'Fold Change',None,'integer',None,COMMON,'')
automatch = Parameter('automatch', 'Auto Match',None,None,['yes_automatch','no_automatch'],SCORE_PATHWAY,'')
geneset = Parameter('geneset', 'Gene Set',None,'string',None,SCORE_PATHWAY,'')
allgenes = Parameter('allgenes', 'All genes',None,None,['yes_allgenes','no_allgenes'],SCORE_PATHWAY,'')
...
PARAMETERS_list = [preprocess,gene_center,gene_normalize,quantile,dwd,bfrm,shiftscale,combat,gene_order,
              ...
              unique_genes,platform,duplicate_probe,has_annotation_gene_id,group_fc,automatch,geneset,allgenes]
