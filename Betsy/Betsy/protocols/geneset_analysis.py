...
CATEGORIES = [COMMON,NORMALIZE,OPTIONAL,ILLUMINA,SCORE_PATHWAY]
#input predicates
INPUTS = [
    'gse_id',
    'gse_id_and_platform',
...
PARAMETERS=[Parameter('preprocess',pretty_name='Preprocess',
            ...
            Parameter('quantile',pretty_name='Quantile',default_value='yes_quantile', 
            ...
            Parameter('has_annotation_gene_id',pretty_name='Annotation Gene Id',default_value='yes_gene_id',
                                   choices=['yes_gene_id','no_gene_id'],category=OPTIONAL,
                      description='how to annotate the output file'),
            Parameter('automatch', pretty_name='Auto Match',choices=['yes_automatch','no_automatch'],
