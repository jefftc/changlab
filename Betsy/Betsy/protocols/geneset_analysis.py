...
CATEGORIES = [COMMON, NORMALIZE, OPTIONAL, ILLUMINA, CLASS_NEIGHBORS,
              SCORE_PATHWAY]
#input  datatype
INPUTS = ['AgilentFiles',
          'ExpressionFiles',
...
PARAMETERS = [
    ...
    #geneset
    Parameter('automatch',
              pretty_name='Auto Match',
              choices=['yes', 'no'],
              category=SCORE_PATHWAY,
              description='will match _UP with _DN (or _DOWN)',
              datatype='GenesetAnalysis'),
    Parameter('allgenes',
              pretty_name='All genes',
              choices=['yes', 'no'],
              category=SCORE_PATHWAY,
              description='Select gene set or not',
              datatype='GenesetAnalysis'),
    Parameter('geneset_value',
              pretty_name='Gene Set',
              category=SCORE_PATHWAY,
