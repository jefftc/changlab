...
column_name=[COMMON,NORMALIZE,OPTIONAL,ILLUMINA,CLASS_NEIGHBORS,CLASSIFY]
#input predicates
INPUTS = [
    'gse_id',
    'class_label_file',
...
unique_genes = Parameter('unique_genes','Unique Genes','no_unique_genes',None,
                         ...
                         COMMON,'')
platform = Parameter('platform','Platform','unknown_platform',None,["'HG_U133_Plus_2'", "'HG_U133B'", "'HG_U133A'",
...
classification = Parameter('classification','Classification Method',None,None,
                                   ['svm', 'weightedvoting', 'randomforest'],CLASSIFY,'')
svm_kernel = Parameter('svm_kernel','SVM Kernel',None,None,
                                   ['linear', 'polynomial', 'rbf', 'sigmoid',
                   'precomputed_kernel'],CLASSIFY,'')
wv_feature_stat = Parameter('wv_feature_stat','Weight Voted Feature Stat',None,None,
                                   ['wv_snr', 'wv_ttest', 'wv_snr_median',
                        'wv_ttest_median',
                        'wv_snr_minstd', 'wv_ttest_minstd',
                        'wv_snr_median_minstd',
                        'wv_ttest_median_minstd'],CLASSIFY,'')
traincontents = Parameter('traincontents','Training contents',None,'list',None,CLASSIFY,'')
testcontents = Parameter('testcontents','Test contents',None,'list',None,CLASSIFY,'')
wv_minstd = Parameter('wv_minstd','Weight Voted min std',None,'float',None,CLASSIFY,'')
...
PARAMETERS_list = [preprocess,gene_center,gene_normalize,quantile,dwd,bfrm,shiftscale,combat,gene_order,
              ...
              unique_genes,platform,duplicate_probe,has_annotation_gene_id,group_fc,classification,
                   svm_kernel,wv_feature_stat,traincontents,testcontents,wv_minstd]
