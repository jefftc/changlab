...
cluster_alg = Parameter('cluster_alg', 'Cluster algorithm','no_cluster_alg',
                        None,['no_cluster_alg'],CLUSTER,'')
...
PARAMETERS_list = [preprocess,gene_center,gene_normalize,quantile,dwd,bfrm,shiftscale,combat,gene_order,
              ...
              unique_genes,platform,duplicate_probe,has_annotation_gene_id,group_fc,cluster_alg,color,
               hm_width, hm_height]
