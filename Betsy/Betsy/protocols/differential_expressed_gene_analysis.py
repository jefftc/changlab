...
column_name=[COMMON,NORMALIZE,OPTIONAL,ILLUMINA,CLASS_NEIGHBORS,DIFF]
#input predicates
INPUTS = [
    'gse_id',
    'class_label_file',
...
diff_expr = Parameter('diff_expr', 'Differential expression method',None,None,['t_test', 'sam'],DIFF,'')
sam_foldchange = Parameter('sam_foldchange', 'Sam Fold Change',None,'float',None,DIFF,'')
sam_delta = Parameter('sam_delta', 'Sam delta',None,'float',None,DIFF,'')
...
PARAMETERS_list = [preprocess,gene_center,gene_normalize,quantile,dwd,bfrm,shiftscale,combat,gene_order,
              ...
              unique_genes,platform,duplicate_probe,has_annotation_gene_id,group_fc,diff_expr,
                   sam_foldchange,sam_delta]
...
##    'gene_order': ['t_test_p', 't_test_fdr', 'by_gene_list',
##                   'no_order', 'by_class_neighbors'],
