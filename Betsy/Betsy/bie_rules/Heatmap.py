...
import Database
Heatmap = DataType("Heatmap", AttributeDef("cluster_alg", [
    'som', 'pca', 'kmeans', 'hierarchical', 'no_cluster_alg'
                   ...
                   AttributeDef('color', ['red_green', 'blue_yellow'],
                                'red_green', 'red_green',
                                help='color to plot the heatmap'),
                   AttributeDef("contents", Database.CONTENTS, 'unspecified',
                                'unspecified',
                                help='contents'),
                   help="Heatmap file")
...
all_modules = [
    Module('plot_signal_heatmap', GeneExpProcessing.SignalFile, Heatmap,
