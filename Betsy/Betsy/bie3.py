...
def _make_ancestor_dict_h(network):
    ...
    while all_nodes:
        ...
        parents = node2parents.get(node_id, set())
...
def _make_ancestor_dict(network):
    ...
    return _make_ancestor_dict_h(network)
