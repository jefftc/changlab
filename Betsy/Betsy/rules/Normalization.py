...
all_modules = [
    ...
    ModuleNode(
        ...
        # Doesn't work right now.  Network too big.
        # Maybe need a new kind of constraint.
        # MUST_BE         Sets to atomic value, always.
        # SAME_AS         Sets to atomic value, depends on other attribute.
        # CAN_BE_ANY_OF_NO_COMBO   Sets to atomic value, but any one of these.
        # CAN_BE_ANY_OF   Sets to enum values.  Combinatorial.
        #
        # Basically, CAN_BE_ANY_OF_NO_COMBO is the same as not
        # specifying it.  But allows user to use a SAME_AS constraint.
        ...
        #Constraint('combat_norm', SAME_AS, 0, 3),
        #Constraint('shiftscale_norm', SAME_AS, 0, 3),
        #onstraint('bfrm_norm', SAME_AS, 0, 3),
        #Constraint('dwd_norm', SAME_AS, 0, 3),
        #Constraint('gene_center', SAME_AS, 0, 3),
        #Constraint('gene_normalize', SAME_AS, 0, 3),
        #Constraint('unique_genes', SAME_AS, 0, 3),
