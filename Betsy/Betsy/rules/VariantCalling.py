...
all_modules = [
    ...
    ModuleNode(
        ...
        [NGS.FastqFile, NGS.SaiFile], NGS.SamFile,
        Constraint("contents", CAN_BE_ANY_OF, BDT.CONTENTS),
    ...
    ModuleNode(
        ...
        [NGS.FastqFile, NGS.FastqFile,
         NGS.SaiFile, NGS.SaiFile], NGS.SamFile,
