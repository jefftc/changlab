...
list_files = []
all_modules = [
    Module('is_sam_folder', BasicDataTypesNGS.RNASeqFile,
           BasicDataTypesNGS.RNASeqFile,
    ...
    Module('is_bam_folder', BasicDataTypesNGS.RNASeqFile,
           BasicDataTypesNGS.RNASeqFile,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           ...
           help=("extract rna files with different format")),
    Module('is_fastq_folder', BasicDataTypesNGS.RNASeqFile,
           BasicDataTypesNGS.RNASeqFile,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Constraint("format_type", MUST_BE, 'unknown'),
           Consequence("contents", SAME_AS_CONSTRAINT),
           Consequence("format_type", BASED_ON_DATA, ['not_fastqfolder',
                                                      'fastqfolder']),
           help=("extract rna files with different format")),
    Module('extract_rna_files_sam', BasicDataTypesNGS.RNASeqFile,
           ...
           help=("extract rna files with different format")),
    Module('extract_rna_files_bam', BasicDataTypesNGS.RNASeqFile,
    ...
    Module('extract_rna_files_fastq', BasicDataTypesNGS.RNASeqFile,
           BasicDataTypesNGS.FastqFolder,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Constraint("format_type", MUST_BE, 'fastqfolder'),
           Consequence("contents", SAME_AS_CONSTRAINT),
           help=("extract rna files with fa or fastq format")),
    Module('align_with_bowtie', [BasicDataTypesNGS.FastqFolder,
                                 BasicDataTypesNGS.SampleGroupFile],
           BasicDataTypesNGS.SamFolder,
    ...
    Module('convert_sam_to_bam', BasicDataTypesNGS.SamFolder,
           BasicDataTypesNGS.BamFolder,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           #Consequence("ref",SET_TO_ONE_OF,['human','mouse']),
    ...
    Module(
        'normalize_with_rsem', [BasicDataTypesNGS.BamFolder,
                                BasicDataTypesNGS.SampleGroupFile],
