...
all_modules = [
    ...
    Module(
        "download_geo_seriesmatrix", Database.GEOSeries,
        Database.GEOSeriesMatrixFile,
        OptionDef("GSEID", help="GSEID to download"),
        OptionDef("GPLID", "", help="GPDID to download"),
        Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
        Consequence("contents", SAME_AS_CONSTRAINT),
    ...
    Module(
        ...
        Database.GEOFamilySoftFile, RenameFile,
     ...
     Module(
        "check_geo_file_type", [ExpressionFiles, Database.GEOSeriesMatrixFile],
        ExpressionFiles,
        Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
