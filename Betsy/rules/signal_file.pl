...
/*-------------------------------------------------------------------------*/
% Input interface
% generate signal_file from signal_norm2 with no_order,unknown_platform,no_unique_genes
...
pca_plot_out(Parameters,Modules):-
    ...
    set_value(NewParameters2,platform,unknown_platform,NewParameters4),
