...
all_modules = [
    Module(
        ...
        SignalFile_rule.PrettySignalFile,ReportFile,
 ...
 #        plot_rule.ControlPlot,
         ...
         Constraint('preprocess',CAN_BE_ANY_OF,['rma','mas5','agilent','loess','unknown']),
         ...
         #Constraint('quantile_norm',CAN_BE_ANY_OF,['yes','no'],5),#when rma, quantile_norm is 'yes'
