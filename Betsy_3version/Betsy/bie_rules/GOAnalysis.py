...
DavidFile = DataType('DavidFile', AttributeDef("contents", Database.CONTENTS,
                                               "unspecified", "unspecified",
                                               help='contents'),
                     help="David result file")
GatherFile = DataType(
    'GatherFile', AttributeDef("network", ['yes', 'no'], 'no', 'no',
                               help="network option in Gather tool"),
    AttributeDef('homologs', ['yes', 'no'], 'no', 'no',
                 help="homologs option in Gather tool"), AttributeDef(
                     'annot_type', ['kegg', 'gene_ontology',
                                    'transfac'], 'kegg', 'kegg',
...
all_modules = [
    Module('annotate_genes_with_david', BasicDataTypes.GeneListFile, DavidFile,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           help="annotate genes with david tool"),
    Module('annotate_genes_with_gather', BasicDataTypes.GeneListFile,
           GatherFile,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT), Constraint(
