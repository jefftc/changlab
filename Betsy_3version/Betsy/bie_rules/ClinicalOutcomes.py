...
ClinicalAnalysis = DataType("ClinicalAnalysis",
                            AttributeDef("contents", Database.CONTENTS,
                                         'unspecified', 'unspecified',
                                         help="contents"),
                            help="Clincal analysis file")
ClinicalFile = DataType("ClinicalFile",
                        AttributeDef("contents", Database.CONTENTS,
                                     'unspecified', 'unspecified',
                                     help="contents"),
...
all_modules = [
    Module('analyze_clinical_outcome', [GeneExpProcessing.SignalFile,
                                        ClinicalFile], ClinicalAnalysis,
           OptionDef("outcome",
                     help="outcome header"), OptionDef("dead",
                                                       help="dead header"),
           OptionDef("genename",
                     help="gene name to analyze"),
           OptionDef("rank_cutoff", 0.5,
                     help="number of rank cutoff"),
           OptionDef("zscore_cutoff", 'n1,1',
                     help="number of zscore cutoff"),
    ...
    Module('analyze_phenotype_for_EMT', [GeneExpProcessing.SignalFile,
                                         CellTypeFile], EMTAnalysis,
           OptionDef("geneset_value",
                     help="geneset value for EMT analysis"),
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS, 0),
           Constraint("contents", SAME_AS, 0, 1),
           Consequence('contents', SAME_AS_CONSTRAINT, 0),
