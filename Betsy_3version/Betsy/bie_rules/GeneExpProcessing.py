...
all_modules = [
    ...
    Module(  #did not consider the diff_expr case 
        "merge_two_classes_rma", [_SignalFile_Merge, _SignalFile_Merge], _SignalFile_Merge, 
    ...
    Module(  
         "reorder_genes",  
         [BasicDataTypes.GeneListFile,_SignalFile_Order], _SignalFile_Order,
    ...
    Module( 
       "relabel_samples",  
        [BasicDataTypes.RenameFile,_SignalFile_Annotate],_SignalFile_Annotate,
