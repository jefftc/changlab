...
list_files = [AgilentFiles, CELFiles, ControlFile, GPRFiles, IDATFiles, ILLUFolder,
...
all_modules = [
    ...
    Module(
        "preprocess_rma",
        CELFiles, GeneExpProcessing._SignalFile_Postprocess,
    ...
    Module(
        "get_illumina_signal",
         ILLUFolder, GeneExpProcessing._SignalFile_Postprocess,
         Consequence('preprocess',SET_TO,"illumina"),
         Consequence('format', SET_TO, "gct"),
         Consequence('logged', SET_TO, "no"),
         Consequence('predataset', SET_TO, "no"),
    ...
    Module(
        "preprocess_agilent",
         AgilentFiles,GeneExpProcessing._SignalFile_Postprocess,
        Constraint("contents",CAN_BE_ANY_OF,Database.CONTENTS),
        Consequence("contents",SAME_AS_CONSTRAINT),
        Consequence('logged',SET_TO,"unknown"),
        Consequence('predataset', SET_TO, "no"),
    ...
    Module(
        ...
        GPRFiles,GeneExpProcessing._SignalFile_Postprocess,
        Consequence("format",SET_TO,"tdf"),
        Consequence("logged",SET_TO,"unknown"),
        Consequence('predataset', SET_TO, "no"),
