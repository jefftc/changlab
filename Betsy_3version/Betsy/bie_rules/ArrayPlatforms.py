...
ILLU_MANIFEST = [
    'HumanHT-12_V3_0_R2_11283641_A.txt', 'HumanHT-12_V4_0_R2_15002873_B.txt',
    'HumanHT-12_V3_0_R3_11283641_A.txt', 'HumanHT-12_V4_0_R1_15002873_B.txt',
    'HumanMI_V1_R2_XS0000122-MAP.txt', 'HumanMI_V2_R0_XS0000124-MAP.txt',
    'HumanRef-8_V2_0_R4_11223162_A.txt',
    'HumanRef-8_V3_0_R1_11282963_A_WGDASL.txt',
    'HumanRef-8_V3_0_R2_11282963_A.txt', 'HumanRef-8_V3_0_R3_11282963_A.txt',
    ...
    'MouseRef-8_V2_0_R2_11278551_A.txt', 'MouseRef-8_V2_0_R3_11278551_A.txt',
...
ILLU_CHIP = ['ilmn_HumanHT_12_V3_0_R3_11283641_A.chip',
...
AgilentFiles = DataType(
    "AgilentFiles",
    AttributeDef("contents", Database.CONTENTS, 'unspecified', 'unspecified',
                 help="contents"),
...
ControlFile = DataType(
    "ControlFile", AttributeDef('preprocess', ["illumina"], "illumina",
                                "illumina",
                                help="preprocess for ControlFile"),
    AttributeDef('missing_values', ["unknown", "no", "yes"], "no", "no",
                 help="missing values yes or not"),
    AttributeDef("missing_algorithm", ["none", "median_fill",
                                       "zero_fill"], "zero_fill", "zero_fill",
                 help="missing algorithm"),
    AttributeDef("logged", ["no"], "no", "no",
                 help="logged yes or not"), AttributeDef('format', ["gct"],
                                                         "gct", "gct",
                                                         help="file format"),
    AttributeDef("contents", Database.CONTENTS, 'unspecified', 'unspecified',
                 help="contents"),
...
ILLUFolder = DataType("ILLUFolder", AttributeDef("illu_manifest", ILLU_MANIFEST, 'HumanHT-12_V4_0_R2_15002873_B.txt', 'HumanHT-12_V4_0_R2_15002873_B.txt', help="illumina manifest"), AttributeDef('illu_chip', ILLU_CHIP, 'ilmn_HumanHT_12_V4_0_R1_15002873_B.chip', 'ilmn_HumanHT_12_V4_0_R1_15002873_B.chip', help="illumina chip type"), AttributeDef('illu_bg_mode', ['false', 'true'], "false", "false", help="illumina background mode"), AttributeDef('illu_coll_mode', ['none', 'max', 'median'], "none", "none", help="illumina coll mode"), AttributeDef("contents", Database.CONTENTS, 'unspecified', 'unspecified', help="contents"), help="A folder generated from preprocess_illumina," \
          "it contains SignalFile_Postprocess and ControlFile.")

ActbPlot = DataType('ActbPlot', AttributeDef("contents", Database.CONTENTS,
...
ControlPlot = DataType('ControlPlot', AttributeDef(
    "contents", Database.CONTENTS, "unspecified", "unspecified",
    help='contents'), AttributeDef("preprocess", GeneExpProcessing.PREPROCESS,
                                   'unknown', 'unknown',
                                   help="preprocess method"),
                       help="control plot file")
BiotinPlot = DataType('BiotinPlot', AttributeDef("contents", Database.CONTENTS,
                                                 "unspecified", "unspecified",
                                                 help='contents'),
...
list_files = [AgilentFiles, CELFiles, ControlFile, GPRFiles, IDATFiles,
              ILLUFolder, ActbPlot, Hyb_barPlot, ControlPlot, BiotinPlot,
              HousekeepingPlot]

all_modules = [
    Module("extract_matrix_data", BasicDataTypes.ExpressionFiles,
    ...
    Module(
        ...
        Consequence("contents", SAME_AS_CONSTRAINT),
        help=
        "preprocess CELFiles with mas5 method,generate SignalFile_Postprocess"),
    # IDATFiles
    Module("extract_illumina_idat_files", BasicDataTypes.ExpressionFiles,
           IDATFiles, Constraint("filetype", MUST_BE, 'idat'),
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           help="extract idat files from Expression File folder"),
    Module("preprocess_illumina", IDATFiles, ILLUFolder,
           ...
           Consequence('illu_coll_mode', SET_TO_ONE_OF, ["none", "max",
                                                         "median"]),
           OptionDef("illu_clm", '',
                     help="illumina clm"),
           OptionDef("illu_custom_chip", '',
                     help="illumina custom chip name"),
           OptionDef("illu_custom_manifest", '',
                     help='illumina custrom manifest file'),
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           help="preprocess idat files,generate SignalFile_Postprocess"),
    Module("get_illumina_control", ILLUFolder, ControlFile,
    ...
    Module("get_illumina_signal", ILLUFolder,
           GeneExpProcessing._SignalFile_Postprocess,
           Consequence('preprocess', SET_TO, "illumina"),
           Consequence('format', SET_TO, "gct"),
           Consequence('logged', SET_TO, "no"),
    ...
    # AgilentFiles
    Module("extract_agilent_files", BasicDataTypes.ExpressionFiles,
           AgilentFiles, Constraint("filetype", MUST_BE, 'agilent'),
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           help="extract agilent files from ExpressionFiles"),
    Module("preprocess_agilent", AgilentFiles,
           GeneExpProcessing._SignalFile_Postprocess,
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           Consequence('logged', SET_TO, "unknown"),
    ...
    # GPRFiles
    Module("extract_gpr_files", BasicDataTypes.ExpressionFiles, GPRFiles,
           Constraint("filetype", MUST_BE, 'gpr'),
           Constraint("contents", CAN_BE_ANY_OF, Database.CONTENTS),
           Consequence("contents", SAME_AS_CONSTRAINT),
           help="extract gpr files from ExpressionFiles"),
    Module("normalize_with_loess", GPRFiles,
           GeneExpProcessing._SignalFile_Postprocess,
           Consequence("format", SET_TO, "tdf"),
           Consequence("logged", SET_TO, "unknown"),
           Consequence('predataset', SET_TO, "no"),
    ...
    Module(
        ...
        Constraint("missing_values", MUST_BE, 'no'), Constraint(
            "contents", CAN_BE_ANY_OF,
            Database.CONTENTS), Consequence("contents", SAME_AS_CONSTRAINT),
    ...
    Module('plot_illu_hyb_bar', ControlFile, Hyb_barPlot,
           Constraint("preprocess", MUST_BE, "illumina"),
           Constraint("format", MUST_BE, "gct"),
           Constraint("logged", MUST_BE, "no"), Constraint(
               "contents", CAN_BE_ANY_OF,
               Database.CONTENTS), Consequence("contents", SAME_AS_CONSTRAINT),
           help="plot illumina affx line"),
    Module('plot_illu_biotin_line', ControlFile, BiotinPlot,
           Constraint("preprocess", MUST_BE, 'illumina'),
           Constraint("format", MUST_BE, "gct"),
           Constraint("logged", MUST_BE, "no"), Constraint(
               "contents", CAN_BE_ANY_OF,
    ...
    Module('plot_illu_housekeeping_line', ControlFile, HousekeepingPlot,
           Constraint("preprocess", MUST_BE, 'illumina'),
           Constraint("format", MUST_BE, "gct"),
           Constraint("logged", MUST_BE, "no"), Constraint(
               "contents", CAN_BE_ANY_OF,
