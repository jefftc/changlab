...
ClassifyFile = DataType(
    'ClassifyFile',
    AttributeDef("classify_alg", ['weighted_voting', 'svm',
                                  'random_forest'], 'svm', 'svm',
                 help="classify algorithm"),
    AttributeDef('wv_feature_stat',
                 ...
                 help="weighted voting feature stat"), AttributeDef(
                     'svm_kernel', ['linear', 'polynomial', 'RBF', 'sigmoid',
                                    'precomputed_kernel'], 'linear', 'linear',
                     help="svm kernel"),
    AttributeDef('loocv', ['yes', 'no'], 'no', 'no',
                 help="loocv yes or not"),
...
PredictionPCAPlot = DataType(
    'PredictionPCAPlot', AttributeDef('classify_alg',
                                      ['weighted_voting', 'svm',
                                       'random_forest', 'no'], 'no', 'no',
                                      help="classify algorithm"),
    AttributeDef('loocv', ['yes', 'no'], 'no', 'no',
                 help="loocv yes or not"),
    AttributeDef('actual_label', ['yes', 'no'], 'no', 'no',
...
PredictionPlot = DataType(
    'PredictionPlot', AttributeDef('classify_alg', ['weighted_voting', 'svm',
                                                    'random_forest'], 'svm',
                                   'svm',
                                   help="classify algorithm"),
    AttributeDef('loocv', ['yes', 'no'], 'no', 'no',
...
all_modules = [
    Module("merge_files_for_classification", [
        GeneExpProcessing.SignalFile, GeneExpProcessing.SignalFile
           ...
           Consequence('logged', SAME_AS_CONSTRAINT, 0), Constraint(
    ...
    Module('classify_with_weighted_voting',
           ...
           OptionDef('wv_num_features', 10,
                     help="number of features for weighted voting"),
           OptionDef('wv_minstd', 1,
           ...
           Consequence("classify_alg", SET_TO, 'weighted_voting'), Consequence(
               'wv_feature_stat', SET_TO_ONE_OF,
               ['wv_snr', 'wv_ttest', 'wv_snr_median', 'wv_ttest_median',
                'wv_snr_minstd', 'wv_ttest_minstd', 'wv_snr_median_minstd',
                'wv_ttest_median_minstd']), Consequence(
                    'svm_kernel', SET_TO_ONE_OF, ['linear', 'polynomial',
                                                  'RBF', 'sigmoid',
                                                  'precomputed_kernel']),
           help="classify with weighted voting method"),
    Module('classify_with_random_forest', [GeneExpProcessing.ClassLabelFile,
                                           GeneExpProcessing.SignalFile],
           ClassifyFile, Constraint("contents", MUST_BE, 'class0,class1', 0),
           Constraint("cls_format", MUST_BE, 'cls', 0),
           Constraint("contents", MUST_BE, 'class0,class1,test', 1),
           Constraint("format", MUST_BE, 'gct', 1),
           #Constraint("logged",MUST_BE,'yes',1),
           Consequence('classify_alg', SET_TO, 'random_forest'), Consequence(
               'wv_feature_stat', SET_TO_ONE_OF,
               ['wv_snr', 'wv_ttest', 'wv_snr_median', 'wv_ttest_median',
                'wv_snr_minstd', 'wv_ttest_minstd', 'wv_snr_median_minstd',
                'wv_ttest_median_minstd']), Consequence(
    ...
    Module('train_svm_model', [GeneExpProcessing.ClassLabelFile,
                               GeneExpProcessing.SignalFile], SvmModel,
           Constraint("contents", MUST_BE, 'class0,class1', 0),
           Constraint("cls_format", MUST_BE, 'cls', 0),
           Constraint("contents", MUST_BE, 'class0,class1,test', 1),
           Constraint("format", MUST_BE, 'gct', 1),
           #Constraint("logged",MUST_BE,'yes',1),
           Consequence("classify_alg", SET_TO,
                       'svm'), Consequence("svm_kernel", SET_TO_ONE_OF,
                                           ['linear', 'polynomial', 'RBF',
                                            'sigmoid', 'precomputed_kernel']),
           help="train data using svm method"),
    Module('classify_with_svm', [GeneExpProcessing.ClassLabelFile,
                                 GeneExpProcessing.SignalFile, SvmModel],
           ClassifyFile, Constraint("contents", MUST_BE, 'class0,class1', 0),
           Constraint("cls_format", MUST_BE, 'cls', 0),
           Constraint("contents", MUST_BE, 'class0,class1,test', 1),
           ...
           Constraint("svm_kernel", CAN_BE_ANY_OF, [
               'linear', 'polynomial', 'RBF', 'sigmoid', 'precomputed_kernel'
           ], 2), Consequence("classify_alg", SAME_AS_CONSTRAINT, 2),
           Consequence("svm_kernel", SAME_AS_CONSTRAINT, 2), Consequence(
               'wv_feature_stat', SET_TO_ONE_OF,
               ['wv_snr', 'wv_ttest', 'wv_snr_median', 'wv_ttest_median',
                'wv_snr_minstd', 'wv_ttest_minstd', 'wv_snr_median_minstd',
                'wv_ttest_median_minstd']),
           help="classify with svm method"),
    Module('run_loocv_weighted_voting', [
        GeneExpProcessing.ClassLabelFile, GeneExpProcessing.SignalFile
    ], ClassifyFile, OptionDef('wv_num_features', 10,
                               help="number of features for weighted voting"),
           OptionDef('wv_minstd', 1,
                     help="minstd for weighted voting"),
           Constraint("contents", MUST_BE, 'class0,class1', 0),
    ...
    Module('run_loocv_svm', [GeneExpProcessing.ClassLabelFile,
                             GeneExpProcessing.SignalFile], ClassifyFile,
           Constraint('contents', MUST_BE, 'class0,class1', 0),
           Constraint("cls_format", MUST_BE, 'cls', 0),
           Constraint("contents", MUST_BE, 'class0,class1', 1),
           Constraint("format", MUST_BE, 'gct', 1),
           #Constraint("logged",MUST_BE,'yes',1),
           Consequence('classify_alg', SET_TO, 'svm'), Consequence(
               'svm_kernel', SET_TO_ONE_OF,
               ['linear', 'polynomial', 'RBF', 'sigmoid',
                'precomputed_kernel']), Consequence("loocv", SET_TO, 'yes'),
           Consequence("actual_label", SET_TO, 'no'), Consequence(
               'wv_feature_stat', SET_TO_ONE_OF,
               ['wv_snr', 'wv_ttest', 'wv_snr_median', 'wv_ttest_median',
                'wv_snr_minstd', 'wv_ttest_minstd', 'wv_snr_median_minstd',
                'wv_ttest_median_minstd']),
           help="run loocv in svm method"),
    Module('run_loocv_random_forest', [GeneExpProcessing.ClassLabelFile,
                                       GeneExpProcessing.SignalFile],
           ClassifyFile, Constraint('contents', MUST_BE, 'class0,class1', 0),
           Constraint("cls_format", MUST_BE, 'cls', 0),
           Constraint("contents", MUST_BE, 'class0,class1', 1),
           ...
           #Constraint("logged",MUST_BE,'yes',1),
           Consequence("classify_alg", SET_TO,
                       'random_forest'), Consequence("loocv", SET_TO, 'yes'),
           Consequence("actual_label", SET_TO, 'no'), Consequence(
               'wv_feature_stat', SET_TO_ONE_OF,
               ['wv_snr', 'wv_ttest', 'wv_snr_median', 'wv_ttest_median',
                'wv_snr_minstd', 'wv_ttest_minstd', 'wv_snr_median_minstd',
    ...
    Module('evaluate_prediction', [GeneExpProcessing.ClassLabelFile,
           ...
           Consequence("actual_label", SET_TO, 'yes'), DefaultAttributesFrom(1),
           help="evalutate prediction with actual label"),
    Module('plot_prediction', ClassifyFile, PredictionPlot,
           Constraint("classify_alg", CAN_BE_ANY_OF, ['weighted_voting', 'svm',
                                                      'random_forest']),
    ...
    Module('plot_sample_pca_with_predictions', [ClassifyFile,
                                                PcaAnalysis.PcaAnalysis],
           PredictionPCAPlot, Constraint('classify_alg', CAN_BE_ANY_OF, [
               'svm', 'weighted_voting', 'random_forest'
           ], 0), Constraint("actual_label", CAN_BE_ANY_OF, ['yes', 'no'], 0),
    ...
    Module('make_classify_report',
           ...
           Constraint("loocv", MUST_BE, 'yes',
                      4), Constraint("classify_alg", MUST_BE, 'svm', 5),
           Constraint("actual_label", MUST_BE, 'yes',
                      5), Constraint("loocv", MUST_BE, 'no', 5),
           Constraint("classify_alg", MUST_BE, 'weighted_voting',
                      6), Constraint("actual_label", MUST_BE, 'yes',
                                     6), Constraint("loocv", MUST_BE, 'no', 6),
           Constraint("classify_alg", MUST_BE, 'weighted_voting',
                      7), Constraint("actual_label", MUST_BE, 'no', 7),
           Constraint("loocv", MUST_BE, 'yes', 7), Constraint(
               "classify_alg", MUST_BE, 'weighted_voting',
               8), Constraint("actual_label", MUST_BE, 'yes',
                              8), Constraint("loocv", MUST_BE, 'no', 8),
           Constraint("classify_alg", MUST_BE, 'weighted_voting',
                      9), Constraint("actual_label", MUST_BE, 'no', 9),
           Constraint("loocv", MUST_BE, 'yes', 9), Constraint(
               "classify_alg", MUST_BE, 'weighted_voting',
               10), Constraint("actual_label", MUST_BE, 'yes',
                               10), Constraint("loocv", MUST_BE, 'no', 10),
