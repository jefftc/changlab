...
def run(data_node, parameters, user_input, network, num_cores):
    ...
    p_value_index = None
    fdr_index = None
    if 'select_gene_by_foldchange' in user_input and user_input[
        'select_gene_by_foldchange'
    ]:
        foldchange = float(user_input['select_gene_by_foldchange'])
    if 'select_gene_by_p_value' in user_input and user_input[
...
def make_unique_hash(data_node, pipeline, parameters, user_input):
    return module_utils.make_unique_hash(data_node.identifier, pipeline,
