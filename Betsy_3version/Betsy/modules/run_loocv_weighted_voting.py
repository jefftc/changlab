...
def run(in_nodes,parameters, user_input,network):
    ...
    for i in range(M.ncol()):
        ...
        train_node = rulebase.SignalFile2(format='gct',contents='class0,class1',
                                          filename='train'+'_'+str(i))
        test_node = rulebase.SignalFile2(format='gct',contents='test',
                                         filename='test'+'_'+str(i))
        train_label_node = rulebase.ClassLabelFile(contents='class0,class1',
                                                   filename='train_label'+'_'+str(i))
