...
#input  datatype
INPUTS = ['AgilentFiles', 'ExpressionFiles', 'RenameFile', 'GPRFiles',
          'GEOSeries', 'IDATFiles', 'CELFiles', '_SignalFile_Postprocess',
          'ClassLabelFile', 'RenameFile', 'GeneListFile']

#output datatype
OUTPUTS = 'DiffReportFile'
...
PARAMETERS = [
    ...
    Parameter('preprocess',
              ...
              choices=normalize_file.PREPROCESS,
              category=COMMON,
    ...
    Parameter(
        ...
        choices=['diff_ttest', 'diff_sam', 'diff_ebayes', 'diff_fold_change'],
        category=NORMALIZE,
    ...
    Parameter(
        'ill_manifest',
        pretty_name='Illumina Manifest File',
        choices=
        ['HumanHT-12_V3_0_R2_11283641_A.txt',
         'HumanHT-12_V4_0_R2_15002873_B.txt', 'HumanHT-12_V3_0_R3_11283641_A.txt',
        ...
        datatype="ILLUFolder"),
    Parameter('ill_chip',
              pretty_name='Illumina chip File',
              choices=['ilmn_HumanHT_12_V3_0_R3_11283641_A.chip',
              ...
              datatype="ILLUFolder"),
    Parameter('ill_clm',
              pretty_name='Illumina clm File',
              category=ILLUMINA,
              description='CLM file to map file names to sample names.',
              datatype="ILLUFolder"),
    Parameter('ill_custom_chip',
              pretty_name='Illumina Custom Chip File',
              category=ILLUMINA,
              description='Other CHIP file to map probes to genes.',
              datatype="ILLUFolder"),
    Parameter('ill_custom_manifest',
              pretty_name='Illumina Custom Manifest File',
              category=ILLUMINA,
              description=
              'Other Illumina manifest file in tab-delimited (TXT) format.',
              datatype="ILLUFolder"),
    Parameter('ill_bg_mode',
              pretty_name='Illumina Background Mode',
              choices=['ill_yes', 'ill_no'],
              category=ILLUMINA,
              description='Perform background subtraction.',
              datatype="ILLUFolder"),
    Parameter(
        'ill_coll_mode',
        pretty_name='Illumina Coll Mode',
        choices=['none', 'max', 'median'],
        category=ILLUMINA,
        description=
        'Collapse probes to genes based on the manifest or CHIP file (if provided).',
        datatype="ILLUFolder"),
    #class neighbors
    ...
    Parameter('diffexp_foldchange_value',
              pretty_name='Diffexp Fold Change',
              category=DIFF,
              description='diff exp fold change number e.g. 1.0',
              datatype='UserInput'),
    Parameter('sam_foldchange_value',
              pretty_name='Sam Fold Change',
              category=DIFF,
              description='sam fold change number e.g. 1.0',
              datatype='UserInput'),
    Parameter('sam_delta_value',
              pretty_name='Sam delta',
              category=DIFF,
              description='sam delta e.g 1.0',
              datatype='UserInput'),
    Parameter('select_gene_by_foldchange',
              pretty_name='Select Gene by Foldchange',
              category=DIFF,
              description='select gene by foldchange value,etc.5',
              datatype='UserInput'),
    Parameter('select_gene_by_p_value',
              pretty_name='Select Gene by p_value',
              category=DIFF,
              description='select gene by p-value value, etc. 0.05',
              datatype='UserInput'),
    Parameter('select_gene_by_fdr',
              pretty_name='Select Gene by fdr',
              category=DIFF,
              description='select gene by fdr value, etc.0.05',
              datatype='UserInput'),
    Parameter('hm_width',
              pretty_name='heatmap width',
              category=DIFF,
              description='heatmap width',
              datatype='UserInput'),
    Parameter('hm_height',
              pretty_name='heatmap height',
              category=DIFF,
