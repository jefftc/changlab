...
PARAMETERS=[Parameter('format',pretty_name='File Format',default_value='tdf',
            ...
            Parameter('diffexp_foldchange_value', pretty_name='Diffexp Fold Change',category=DIFF,
                      description='diff exp fold change number e.g. 1.0',datatype='UserInput'),
            ...
            Parameter('select_gene_by_foldchange', pretty_name='Select Gene by Foldchange',category=DIFF,
                      description='select gene by foldchange value,etc.5',datatype='UserInput'),
            Parameter('select_gene_by_p_value', pretty_name='Select Gene by p_value',category=DIFF,
                      description='select gene by p-value value, etc. 0.05',datatype='UserInput'),
            Parameter('select_gene_by_fdr', pretty_name='Select Gene by fdr',category=DIFF,
                      description='select gene by fdr value, etc.0.05',datatype='UserInput'),
            Parameter('hm_width', pretty_name='heatmap width',category=DIFF,
                      description='heatmap width',datatype='UserInput'),
            Parameter('hm_height', pretty_name='heatmap height',category=DIFF,
