...
PARAMETERS=[Parameter('format',pretty_name='File Format',default_value='tdf',
            ...
            Parameter('gene_order',pretty_name='Gene Order',default_value='t_test_p',
            ...
            #diffenet_expr related
           
                     
            Parameter('diff_expr', pretty_name='Differential expression method',
                      choices=['t_test', 'sam'],category=DIFF,
                      description='method of differential expression analysis',datatype='DiffExprFile'),
            Parameter('sam_foldchange_value', pretty_name='Sam Fold Change',category=DIFF,
                      description='sam fold change number e.g. 1.0',datatype='UserInput'),
            Parameter('sam_delta_value', pretty_name='Sam delta',category=DIFF,
                      description='sam delta e.g 1.0',datatype='UserInput'),
            Parameter('report_type',pretty_name='differential genes report',category=COMMON,
                      choices=['diffgenes'],
                      default_value='diffgenes',description='make differential genes report',
                      datatype='ReportFile'),
            ]
