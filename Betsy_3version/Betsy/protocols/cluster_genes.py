...
PARAMETERS=[Parameter('format',pretty_name='File Format',default_value='tdf',
            ...
            Parameter('cluster_alg', pretty_name='Cluster algorithm',default_value='kmeans',
                      ...
                      description='cluster algorithm',datatype='ClusterFile'),
            Parameter('distance', pretty_name='Distance',default_value='correlation',
                      choices=['correlation', 'euclidean'],category=CLUSTER,
                      description='distance method in cluster',datatype='ClusterFile'),
            Parameter('k-value', pretty_name='K value',category=CLUSTER,
                      description='K number in K means',datatype='UserInput'),
            ...
            Parameter('report_type',pretty_name='cluster report',category=COMMON,
                      choices=['cluster'],
                      default_value='cluster',description='make cluster report',
                      datatype='ReportFile'),
]
