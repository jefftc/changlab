...
PARAMETERS=[Parameter('format',pretty_name='File Format',default_value='tdf',
            ...
            Parameter('classification',pretty_name='Classification Method',
                      ...
                      description='classification method',datatype='ClassifyFile'),
            Parameter('svm_kernel',pretty_name='SVM Kernel',
                                   choices=['linear', 'polynomial', 'rbf', 'sigmoid',
                   'precomputed_kernel'],category=CLASSIFY,description='svm kernel',datatype='ClassifyFile'),
            Parameter('wv_feature_stat',pretty_name='Weighted Voting Feature Stat',
                                   choices=['wv_snr', 'wv_ttest', 'wv_snr_median',
                        'wv_ttest_median',
                        'wv_snr_minstd', 'wv_ttest_minstd',
                        'wv_snr_median_minstd',
                        'wv_ttest_median_minstd'],category=CLASSIFY,description='weighted voting feature stat method',
                      datatype='ClassifyFile'),
            Parameter('wv_minstd',pretty_name='Weight Voted min std',type='float',category=CLASSIFY,
                      description='weighted voting min std e.g. 1.0',datatype='UserInput'),
            Parameter('report_type',pretty_name='classifcation report',category=COMMON,
                      choices=['classify'],
                      default_value='classify',description='make classification report',
                      datatype='ReportFile'),
