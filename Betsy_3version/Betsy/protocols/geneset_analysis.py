...
PARAMETERS=[Parameter('format',pretty_name='File Format',default_value='tdf',
            ...
            Parameter('report_type',pretty_name='normalize report',category=COMMON,
                      choices=['normalize_file'],
                      default_value='normalize_file',description='make normalize report'
                      datatype='ReportFile'),
            ###illumina related
            ...
            Parameter('geneset', pretty_name='Gene Set',choices=['yes','no'],
                      category=SCORE_PATHWAY,description='will match _UP with _DN (or _DOWN)',
                      datatype='GenesetAnalysis'),
            Parameter('allgenes', pretty_name='All genes',choices=['yes','no'],
                      category=SCORE_PATHWAY,description='Select gene set or not',
                      datatype='GenesetAnalysis'),
            Parameter('geneset_value', pretty_name='Gene Set',category=SCORE_PATHWAY,
                      description='geneset names sperate by ","',datatype='UserInput'),
